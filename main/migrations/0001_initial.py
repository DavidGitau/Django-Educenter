# Generated by Django 4.0.3 on 2022-07-05 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_courses', models.ManyToManyField(to='main.course')),
                ('t_interest', models.ManyToManyField(to='main.interest')),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(default='')),
                ('summary', models.TextField(default='Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe ipsa illo quod veritatis, magni debitis fugiat dolore voluptates! Consequatur, aliquid. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat perferendis sint optio similique. Et amet magni facilis vero corporis quos.')),
                ('s_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.course')),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('e_speaker', models.ManyToManyField(to='main.teacher')),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='course',
            name='c_requirement',
            field=models.ManyToManyField(to='main.requirement'),
        ),
        migrations.AddField(
            model_name='course',
            name='c_teacher',
