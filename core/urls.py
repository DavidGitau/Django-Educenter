...
urlpatterns = [
        ...
        path('account/', include('login.urls', namespace='u-account')),
        path('contact/account/', include('login.urls', namespace='ac-account')),
        path('about/account/', include('login.urls', namespace='ab-account')),
